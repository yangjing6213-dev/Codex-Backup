...
1. Open [GitHub Releases](https://github.com/yangjing6213-dev/Codex-Backup/releases) for actually published versions. The 0.1.9 assets are the [Windows x64 installer](https://github.com/yangjing6213-dev/Codex-Backup/releases/download/v0.1.9/ENHE.Codex.Backup_0.1.9_x64-setup.exe) and [SHA-256 checksum](https://github.com/yangjing6213-dev/Codex-Backup/releases/download/v0.1.9/ENHE.Codex.Backup_0.1.9_x64-setup.exe.sha256). The installer is unsigned; verify its SHA-256 before installation.
