...
| --- | --- | --- |
| Application | ENHE Codex Backup 0.1.7, Windows 11 x64 | Fresh verification, NSIS build and current-user replacement installation PASS; see STATUS and installer verification. Native UI and live-account acceptance remain NOT_RUN; historical 0.1.6 startup results do not prove 0.1.7 startup. |
| Windows | Windows 11 x64, current user | Authorized 0.1.6 uninstall/0.1.7 install passed. Registry, installed binary/resources, shortcuts and preserved configuration verified. The installed app was not launched; clean-profile launch is NOT_RUN. |
