...
| --- | --- | --- |
| Application | ENHE Codex Backup 0.1.0, Windows 11 x64 | Source implemented; release Tauri compilation, current-user install, and startup were verified. Full desktop UI flow remains NOT_RUN. |
| Windows | Windows 11 x64, current user | Resource binaries were executed on Windows 11 Pro x64. Current-user installer launch passed; clean-device launch is NOT_RUN. |
